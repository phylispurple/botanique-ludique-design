...
const AtelierBotaniqueEnfantHautsDeSeine = () => {
  ...
  const faqQuestions = [
    { question: "Quels ateliers nature pour enfants dans le 92 ?", answer: "Bombes à graines, terrarium, herbier créatif, teinture végétale, kokedama, semis et bouturage. Tous adaptés à l'âge des enfants, de la maternelle au collège." },
    { question: "Intervenez-vous dans les centres de loisirs du 92 ?", answer: "Oui, nous intervenons dans les centres de loisirs, les écoles, les MJC et les associations des Hauts-de-Seine. Pendant le temps scolaire, périscolaire et les vacances." },
    { question: "Quel est le tarif pour un groupe d'enfants ?", answer: "Le tarif dépend du nombre d'enfants, de la durée et du type d'atelier. Nous établissons un devis personnalisé gratuit sous 24h." }
  ];

  return (
    <div className="min-h-screen relative" style={{ backgroundColor: 'hsl(36 33% 93%)' }}>
      <SEO
        title="Atelier Botanique Enfant Hauts-de-Seine (92)"
        description="Ateliers botaniques pour enfants dans les Hauts-de-Seine (92). Activités nature : terrarium, teinture, herbier. Écoles, centres de loisirs à Boulogne, Nanterre, Rueil."
        keywords="atelier botanique enfant hauts-de-seine, atelier nature enfant 92, activité plantes enfant boulogne, animation nature enfant nanterre"
        canonical="/atelier-botanique-enfant-hauts-de-seine"
        region="FR-IDF"
      />
      <SchemaOrg type="Service" data={{ serviceType: "Atelier botanique enfant", name: "Atelier Botanique Enfant Hauts-de-Seine (92)", description: "Ateliers botaniques pour enfants dans les Hauts-de-Seine." }} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Ateliers Botaniques <span className="text-sage">Enfants</span> dans les Hauts-de-Seine
              </h1>
              <p className="subtitle-italic text-lg mb-6">Ludiques · Pédagogiques · Dès 3 ans · Tout le département 92</p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Du <strong>parc de Saint-Cloud</strong> aux espaces verts de Boulogne-Billancourt, les Hauts-de-Seine offrent
                un terrain de jeu idéal pour éveiller les enfants à la <strong>botanique et aux sciences naturelles</strong>.
              </p>
            </div>
      <LandingPhotoStrip />
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {[
                { src: galleryTerrarium, title: "Terrarium enfant", desc: "Un monde miniature à créer" },
                { src: galleryTeinture, title: "Teinture végétale", desc: "Magie des couleurs naturelles" },
                { src: galleryKokedama, title: "Kokedama", desc: "Art végétal pour petites mains" }
              ].map((a, i) => (
            ...
            <div className="bg-sand p-8 mb-16">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {["Matériel fourni", "Création à emporter", "Dès 3 ans", "8 à 30 enfants", "Tout le département 92", "Devis gratuit sous 24h"].map((b, i) => (
            ...
            <div className="bg-sage text-[hsl(var(--cream))] p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Archivo Black, sans-serif', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>Un atelier nature pour enfants dans le 92 ?</h2>
              <p className="text-lg mb-6 max-w-2xl mx-auto opacity-90">Devis gratuit sous 24h · Tout le 92 · Dès 3 ans</p>
...
export default AtelierBotaniqueEnfantHautsDeSeine;
