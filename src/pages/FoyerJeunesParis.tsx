...
const FoyerJeunesParis = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Un atelier botanique pour foyer de jeunes travailleur·ses dans le Paris. Format inclusif, sans préjugé, qui pose un moment de calme et de créativité.",
    "why": [
        {
            "title": "Apaisant",
