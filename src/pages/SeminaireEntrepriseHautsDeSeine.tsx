...
const SeminaireEntrepriseHautsDeSeine = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Une animation qui ne ressemble pas aux autres, dans le Hauts-de-Seine. Un temps végétal en plein milieu de votre séminaire, qui crée du lien autrement et marque durablement.",
    "why": [
        {
    ...
    "faqs": [
        {
            ...
            "a": "Oui, à Boulogne-Billancourt, Nanterre, Issy-les-Moulineaux, Neuilly et plus largement. Notre équipe se déplace avec tout le matériel."
        },
        {
