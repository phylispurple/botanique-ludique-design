...
import { MapPin, Users, Sprout, GraduationCap, Heart, Building, BookOpen } from "lucide-react";
...
const faqQuestions = [
  { question: "Proposez-vous de la animations botaniques créatives dans les Yvelines (78) ?", answer: "Oui ! Nous intervenons dans tout le département des Yvelines (78), notamment à Saint-Germain-en-Laye, Versailles, Chatou, Le Vésinet, Le Pecq. Nous nous déplaçons dans vos locaux ou structures partenaires." },
  { question: "Quels publics sont concernés par la animations botaniques créatives ?", answer: "Nous intervenons auprès de tous les publics : entreprises, écoles, EHPAD, collectivités, associations, médiathèques, musées et particuliers." },
...
const AnimationBotaniqueYvelines = () => {
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#F7F7EB' }}>
      <SEO
        title="Animation Botanique Yvelines (78)"
        description="Animation Botanique dans les Yvelines (78). Conférences, ateliers et interventions botaniques à Saint-Germain-en-Laye, Versailles, Chatou, Le Vésinet, Le Pecq. Ethnobotaniste diplômée EHESS."
        keywords="animation botanique, atelier botanique, atelier plantes, animation nature, yvelines, 78, saint-germain-en-laye, versailles, chatou, le vésinet"
        canonical="/animation-botanique-yvelines"
        region="FR-78"
        city="Saint-Germain-en-Laye"
      />
      <SchemaOrg type="Service" data={{
        serviceType: "Animation Botanique",
        name: "Animation Botanique - Yvelines (78)",
        description: "Animation Botanique pour tous publics dans les Yvelines.",
        areaServed: ["Yvelines"]
      }} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Animation Botanique dans les Yvelines (78)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Animations botaniques créatives · Yvelines · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>animations botaniques créatives</strong> dans tout le département des Yvelines (78). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400, color: '#3D3D2E' }}>
                    Animation Botanique à Saint-Germain-en-Laye et dans les Yvelines
                  </h2>
                ...
                {[
                  ...
                  <Card key={i} className="hover:shadow-lg transition-shadow animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
                    <CardContent className="p-0">
                      <img src={atelier.src} alt={`Animation Botanique Yvelines - ${atelier.title}`} className="w-full h-48 object-cover rounded-t-lg" loading="lazy" />
                      <div className="p-6">
            ...
            <div className="bg-sage/10 rounded-lg p-8 mb-16 animate-fade-in">
              ...
              <p className="text-center text-sm text-charcoal/60 mt-6">
                ...
                <Link to="/animation-botanique-ile-de-france" className="text-sage underline">Voir toutes nos zones d'intervention</Link>
              </p>
            </div>
            ...
            <div className="bg-sage text-off-white rounded-lg p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400 }}>
                Besoin d'une animation botanique dans les Yvelines ?
              </h2>
...
export default AnimationBotaniqueYvelines;
