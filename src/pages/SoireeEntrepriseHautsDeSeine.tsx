...
const SoireeEntrepriseHautsDeSeine = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Une animation de soirée qui ne perturbe pas le cocktail, dans Hauts-de-Seine. Format debout, fluide, où chacun·e passe à son rythme et repart avec une création.",
    "why": [
            {
                    "title": "Format debout",
