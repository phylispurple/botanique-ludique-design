...
const OnboardingYvelines = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Intégrer ses nouvelles recrues autrement, dans le Yvelines. Un atelier botanique pour faire connaissance, créer des liens et marquer le premier jour.",
    "why": [
        {
