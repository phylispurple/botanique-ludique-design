...
const EvjfYvelines = () => (
  <ProductTemplate data={{
    ...
    "lead": "Un EVJF qui ne mise pas sur les paillettes. Dans le Yvelines, nous proposons un format manuel et tendre, où la future mariée et ses proches vivent un moment vrai autour des plantes.",
    "story": [
        ...
        "Nous intervenons à Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et dans tout le 78. À domicile, dans une salle privée ou un lieu choisi par vous.",
    ...
    "faqs": [
        {
            ...
            "a": "Oui, partout dans le Yvelines : Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie. Nous arrivons avec tout le matériel."
        },
        {
