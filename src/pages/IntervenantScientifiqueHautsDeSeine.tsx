        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <p className="subtitle-italic text-lg mb-6">Ethnobotaniste · Interventions scientifiques · Boulogne, Nanterre, Rueil</p>
            ...
            <div className="bg-sand rounded-lg p-8 mb-16">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {["Ethnobotaniste diplômée EHESS", "Interventions dans tout le 92", "Matériel fourni", "Approche scientifique unique", "Tous publics, tous âges", "Devis gratuit sous 24h"].map((b, i) => (
