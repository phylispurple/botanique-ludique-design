      ...
      <article className="pt-32 pb-20 px-6 md:px-16 lg:px-[120px]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-[hsl(var(--black))]/85 space-y-6">
              ...
              <p>
                Parc de la Croix du Bois, ferme Decauville, bassin de la Sourderie avec son « Versailles du peuple » signé Ricardo Bofill, puis écoquartier du Parc du Lac. Quatre stations, quatre couches de pouvoir, quatre manières d'organiser le vivant. Le fil rouge tient en une phrase, empruntée à Philippe Descola, Pierre Bourdieu et Eric Hobsbawm. Le jardin n'est jamais innocent. Il est toujours une déclaration sur le rapport au pouvoir, au vivant et à l'autre. Cette logique guide aussi nos <Link to="/balade-botanique-yvelines" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">balades ethnobotaniques dans les Yvelines</Link>.
              </p>
              ...
              <p>
                Tout bascule à la fin du XVIIIe siècle avec l'arrivée des roses chinoises dans les cales des bateaux de la Compagnie des Indes. Elles apportent une révolution génétique, la remontée de floraison, du mois de mai jusqu'aux gelées. C'est ce qu'on appellera la rosomanie. De quelques dizaines de variétés, on passe à cinq mille six cents en 1900. Le fond génétique de toutes les roses cultivées devient asiatique, sans que personne ne le dise ni ne le sache. La route des Indes irrigue littéralement nos jardins. Ce même récit d'extraction et de circulation mondiale se retrouve dans nos articles sur la <Link to="/blog/monstera-plante-coloniale-distinction-sociale" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">monstera, plante coloniale de la distinction</Link>, sur les <Link to="/blog/palmiers-architecture-haussmannienne-colonialisme" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">palmiers de l'architecture haussmannienne</Link>, ou encore sur le <Link to="/blog/terrarium-biopiraterie-histoire-coloniale" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">terrarium et la biopiraterie coloniale</Link>.
              </p>
              <p>
              ...
              <p>
                Les Graham Thomas, The Pilgrim ou Tess of Duberville classées sur le panneau comme « roses anglaises » sont des créations de David Austin à partir des années 1960. Croisements de roses anciennes parfumées et d'hybrides modernes remontants, baptisées d'après des poètes victoriens. La catégorie « roses anglaises » n'est reconnue par aucune société horticole officielle. C'est exactement ce qu'Eric Hobsbawm appelait une tradition inventée. Austin vend une ancienneté fabriquée, comme le propriétaire du jardin reconstruisait un passé humaniste qu'il n'avait pas vécu. Cette logique de la <Link to="/blog/monstera-plante-coloniale-distinction-sociale" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">distinction par le végétal importé</Link> traverse toute l'histoire des jardins urbains.
              </p>
              ...
              <p>
                Autrement dit, l'outil mis au point pour évacuer les betteraves d'un champ d'Île-de-France devient un instrument d'extraction à l'échelle des empires. Une distillerie de village s'inscrit ainsi dans une chaîne mondiale, betterave et canne, blocus et plantations, sucre métropolitain et sucre colonial, voie ferrée portative et logistique impériale. L'ethnobotanique n'est jamais loin de l'histoire économique. Pour approfondir le lien entre botanique et pouvoir, vous pouvez consulter notre <Link to="/guide-ethnobotanique" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">guide de l'ethnobotanique</Link> ou découvrir nos <Link to="/balade-botanique-coloniale-paris" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">balades sur le thème colonial</Link>.
              </p>
              ...
              <p>
                Le nom même de Kaufman and Broad mérite qu'on s'y arrête. L'entreprise est fondée à Detroit en 1957 par Eli Broad et Donald Kaufman, en plein boom pavillonnaire d'après-guerre. Elle incarne le modèle américain de réussite par la maison individuelle, ce que les sociologues états-uniens ont théorisé sous le nom d'American Dream. Une maison clé en main, un jardin privatif, une pelouse rase, une allée de garage, l'accession à la propriété comme rite de passage vers la classe moyenne. Kaufman and Broad arrive en France en 1968, et acclimate sur le territoire francilien un produit profondément culturel, pas seulement un produit immobilier. À Chamfleury comme dans des dizaines d'autres opérations en grande couronne, on ne vend pas seulement des mètres carrés, on vend une grammaire de la réussite résidentielle importée d'outre-Atlantique. Le végétal y joue un rôle précis. Haies taillées, gazon homogène, essences d'ornement répétées d'une parcelle à l'autre. La nature devient le décor stable qui signale que l'on a réussi. La <Link to="/blog/monstera-plante-coloniale-distinction-sociale" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">monstera et autres plantes de la distinction</Link> fonctionnent sur le même principe, à l'échelle du salon plutôt que du jardin.
              </p>
              <p>
              ...
              <p>
                Le parallèle avec les suburbs américains des années 1950-1970, ceux-là mêmes que Kaufman and Broad a contribué à bâtir avant de les exporter, est éclairant. Pelouses homogènes, arbres d'ornement, absence de clôtures hautes. La nature comme décor social uniforme plutôt que comme milieu vivant. Descola y voit le naturalisme accompli. La nature réduite à un fond de scène esthétique, débarrassée de toute altérité, de tout imprévu, de tout non-humain autonome. L'écoquartier contemporain corrige cette épure en réintroduisant du vivant non maîtrisé, vergers, noues, prairies fleuries, mais le geste reste un geste de distinction culturelle. On est passé du gazon ras américain au verger participatif européen, sans jamais cesser de signifier, par le végétal, à quelle classe sociale on appartient.
              </p>
              ...
              <p>
                Les plantes n'ont pas changé. C'est le regard que nous posons sur elles qui dit tout. C'est précisément ce que nous proposons dans nos <Link to="/balade-botanique-yvelines" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">balades ethnobotaniques en Île-de-France</Link>. Une lecture du végétal qui assume sa profondeur historique, économique et politique, sans jamais rien retirer au plaisir de regarder une rose s'ouvrir.
              </p>
              ...
              <p>
                Cette balade est proposée en version pédagogique pour les <Link to="/etablissements-scolaires" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">établissements scolaires</Link>, en version culturelle pour les médiathèques et musées, et en version médiation pour les collectivités et bailleurs des Yvelines. Elle se décline aussi dans d'autres communes franciliennes, en partant à chaque fois du paysage local pour remonter aux récits mondiaux qu'il porte. Vous pouvez aussi lire notre retour sur la <Link to="/blog/balade-botanique-ecole-du-breuil" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">balade botanique de l'École du Breuil</Link>, ou consulter notre article sur la <Link to="/blog/mediation-scientifique-definition-exemples" className="underline decoration-[3px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">médiation scientifique</Link> pour comprendre comment cette démarche s'adapte aux publics scolaires et associatifs.
              </p>
              ...
              <div className="my-8 p-6 border-[3px] border-[hsl(var(--black))] shadow-brutal bg-white">
                ...
                <ul className="space-y-2 font-body text-sm text-[hsl(var(--black))]/85">
                  <li>
                    <Link to="/blog/monstera-plante-coloniale-distinction-sociale" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Monstera : plante coloniale de la distinction sociale</Link>
                  </li>
                  <li>
                    <Link to="/blog/palmiers-architecture-haussmannienne-colonialisme" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Palmiers, architecture haussmannienne et colonialisme</Link>
                  </li>
                  <li>
                    <Link to="/blog/terrarium-biopiraterie-histoire-coloniale" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Terrarium, biopiraterie et histoire coloniale</Link>
                  </li>
                  <li>
                    <Link to="/blog/balade-botanique-ecole-du-breuil" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Balade botanique à l'École du Breuil</Link>
                  </li>
                  <li>
                    <Link to="/blog/plantes-sauvages-sortie-scolaire-ile-de-france" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Plantes sauvages et sortie scolaire en Île-de-France</Link>
                  </li>
                  <li>
                    <Link to="/blog/teinture-vegetale-chou-rouge-indigo-naturel" className="underline decoration-[2px] underline-offset-2 decoration-[hsl(var(--olive))] hover:text-[hsl(var(--olive))] transition-colors">Teinture végétale au chou rouge et à l'indigo naturel</Link>
                  </li>
                </ul>
              </div>
