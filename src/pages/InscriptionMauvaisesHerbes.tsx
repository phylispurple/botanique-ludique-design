...
const InscriptionMauvaisesHerbes = () => {
  ...
  return (
    <div className="min-h-screen relative bg-background">
      <SEO
        title="Inscription Atelier Mauvaises herbes – 6 mai 2026 | Botanique Ludique"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-foreground/70 italic" style={{ fontFamily: 'Fraunces, serif' }}>
                Histoire des jardins punk et de la politique des plantes sauvages en ville, suivie de la fabrication de bombes à graines à lancer dans les friches urbaines.
              </p>
              <p className="text-sm text-foreground/60 mt-4 leading-relaxed">
                Atelier tout public mêlant récit culturel et politique des "mauvaises herbes" et pratique végétale. Vous repartez avec vos bombes à graines à disséminer.
              </p>
            </div>
            ...
            <div className="border-t border-b border-border py-6 mb-10 grid sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground">Mercredi 6 mai 2026</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
