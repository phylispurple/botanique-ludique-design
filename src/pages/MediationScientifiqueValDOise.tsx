...
const faqQuestions = [
  { question: "Proposez-vous de la médiation scientifique botanique dans le Val-d'Oise (95) ?", answer: "Oui ! Nous intervenons dans tout le département du Val-d'Oise (95), notamment à Cergy, Pontoise, Argenteuil, Sarcelles, Enghien-les-Bains. Nous nous déplaçons dans vos locaux ou structures partenaires." },
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: 'hsl(36 33% 93%)' }}>
      <SEO
        ...
        description="Médiation Scientifique dans le Val-d'Oise (95). Conférences, ateliers et interventions botaniques à Cergy, Pontoise, Argenteuil, Sarcelles, Enghien-les-Bains. Ethnobotaniste diplômée EHESS."
      ...
      <SchemaOrg type="Service" data={{
        ...
        description: "Médiation Scientifique pour tous publics dans le Val-d'Oise.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Médiation Scientifique dans le Val-d'Oise (95)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Médiation scientifique botanique · Val-d'Oise · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>médiation scientifique botanique</strong> dans tout le département du Val-d'Oise (95). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Archivo Black, sans-serif', color: 'hsl(0 0% 10%)', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>
                    Médiation Scientifique à Cergy et dans le Val-d'Oise
                  </h2>
            ...
            <div className="bg-sage text-[hsl(var(--cream))] p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Archivo Black, sans-serif', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>
                Besoin d'une médiation scientifique dans le Val-d'Oise ?
              </h2>
