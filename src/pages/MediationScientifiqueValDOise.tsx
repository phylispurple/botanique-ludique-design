...
const faqQuestions = [
  { question: "Proposez-vous de la médiation scientifique botanique dans les Val-d'Oise (95) ?", answer: "Oui ! Nous intervenons dans tout le département des Val-d'Oise (95), notamment à Cergy, Pontoise, Argenteuil, Sarcelles, Enghien-les-Bains. Nous nous déplaçons dans vos locaux ou structures partenaires." },
...
const MediationScientifiqueValDOise = () => {
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#F7F7EB' }}>
      <SEO
        title="Médiation Scientifique Val-d'Oise (95)"
        description="Médiation Scientifique dans les Val-d'Oise (95). Conférences, ateliers et interventions botaniques à Cergy, Pontoise, Argenteuil, Sarcelles, Enghien-les-Bains. Ethnobotaniste diplômée EHESS."
        keywords="médiation scientifique, vulgarisation scientifique, conférence botanique, val-d'oise, 95, cergy, pontoise, argenteuil, sarcelles"
        canonical="/mediation-scientifique-val-d-oise"
        region="FR-95"
        city="Cergy"
      />
      <SchemaOrg type="Service" data={{
        serviceType: "Médiation Scientifique",
        name: "Médiation Scientifique - Val-d'Oise (95)",
        description: "Médiation Scientifique pour tous publics dans les Val-d'Oise.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Médiation Scientifique dans les Val-d'Oise (95)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Médiation scientifique botanique · Val-d'Oise · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>médiation scientifique botanique</strong> dans tout le département des Val-d'Oise (95). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400, color: '#3D3D2E' }}>
                    Médiation Scientifique à Cergy et dans les Val-d'Oise
                  </h2>
                ...
                {[
                  ...
                  <Card key={i} className="hover:shadow-lg transition-shadow animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
                    <CardContent className="p-0">
                      <img src={atelier.src} alt={`Médiation Scientifique Val-d'Oise - ${atelier.title}`} className="w-full h-48 object-cover rounded-t-lg" loading="lazy" />
                      <div className="p-6">
            ...
            <div className="bg-sage text-off-white rounded-lg p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400 }}>
                Besoin d'une médiation scientifique dans les Val-d'Oise ?
              </h2>
...
export default MediationScientifiqueValDOise;
