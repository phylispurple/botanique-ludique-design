...
const AnniversaireAdulteYvelines = () => (
  <ProductTemplate data={{
    ...
    "lead": "Fêter un anniversaire sans bar ni karaoké, en plantant ses mains dans la terre et en repartant avec un objet vivant. Dans le Yvelines, ce format séduit celles et ceux qui veulent du sens.",
    "story": [
        ...
        "Nous intervenons à Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et dans tout le 78, à domicile ou dans un lieu privatisé.",
    ...
    "faqs": [
        {
            "q": "Déplacement dans le 78 ?",
            "a": "Oui. Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et zones limitrophes incluses."
        },
        {
