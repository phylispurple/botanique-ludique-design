...
const TeintureVegetaleYvelines = () => (
  <ProductTemplate data={{
    ...
    "lead": "Avant l'arrivée des colorants de synthèse au 19e siècle, toutes les fibres textiles étaient teintes par des plantes. Cet atelier, dans Yvelines, remet en main ces gestes oubliés : roses de la garance, bleus de l'indigo, ocres des pelures d'oignon.",
    "story": [
            ...
            "Notre public mêle familles installées dans les villes de l'ouest parisien, comités d'entreprise des sièges sociaux du Mantois et institutions culturelles autour du château de Versailles. L'atelier a lieu à Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et plus largement dans Yvelines. Chaque participant·e repart avec un échantillon textile teint de ses mains et la documentation pour reproduire chez soi."
    ],
    "steps": [
            {
    ...
    "faqs": [
            {
                    ...
                    "a": "Oui, à Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et au-delà. Pour les communes plus éloignées, nous étudions chaque demande, parfois avec des frais de déplacement modestes."
            },
            {
