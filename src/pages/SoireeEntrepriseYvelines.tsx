...
const SoireeEntrepriseYvelines = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Une animation de soirée qui ne perturbe pas le cocktail, dans le Yvelines. Format debout, fluide, où chacun·e passe à son rythme et repart avec une création.",
    "why": [
        {
            "title": "Format debout",
    ...
    "faqs": [
        {
            ...
            "a": "Oui, Versailles, Saint-Germain-en-Laye, Maurepas, Mantes-la-Jolie et au-delà."
        },
        {
