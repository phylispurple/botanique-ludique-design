...
const MediationBotaniqueHautsDeSeine = () => {
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#F7F7EB' }}>
      <SEO
        title="Médiation Botanique Hauts-de-Seine (92)"
        description="Médiation Botanique dans les Hauts-de-Seine (92). Conférences, ateliers et interventions botaniques à Boulogne-Billancourt, Nanterre, Rueil-Malmaison, Issy-les-Moulineaux, Levallois-Perret. Ethnobotaniste diplômée EHESS."
        keywords="médiation botanique, médiation végétale, atelier plantes, hauts-de-seine, 92, boulogne-billancourt, nanterre, rueil-malmaison, issy-les-moulineaux"
        canonical="/mediation-botanique-hauts-de-seine"
        region="FR-92"
        city="Boulogne-Billancourt"
      />
      <SchemaOrg type="Service" data={{
        serviceType: "Médiation Botanique",
        name: "Médiation Botanique - Hauts-de-Seine (92)",
        description: "Médiation Botanique pour tous publics dans les Hauts-de-Seine.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Médiation Botanique dans les Hauts-de-Seine (92)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Médiation botanique · Hauts-de-Seine · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>médiation botanique</strong> dans tout le département des Hauts-de-Seine (92). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400, color: '#3D3D2E' }}>
                    Médiation Botanique à Boulogne-Billancourt et dans les Hauts-de-Seine
                  </h2>
                ...
                {[
                  ...
                  <Card key={i} className="hover:shadow-lg transition-shadow animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
                    <CardContent className="p-0">
                      <img src={atelier.src} alt={`Médiation Botanique Hauts-de-Seine - ${atelier.title}`} className="w-full h-48 object-cover rounded-t-lg" loading="lazy" />
                      <div className="p-6">
            ...
            <div className="bg-sage text-off-white rounded-lg p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400 }}>
                Besoin d'une médiation botanique dans les Hauts-de-Seine ?
              </h2>
...
export default MediationBotaniqueHautsDeSeine;
