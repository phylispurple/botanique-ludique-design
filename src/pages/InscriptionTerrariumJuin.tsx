  ...
  return (
    <>
      <SEO
        ...
        description="Inscrivez-vous à l'atelier Wardian Case du 6 juin 2026 : histoire culturelle du terrarium et fabrication. Bocal 3L (12€) ou 5L verre recyclé bouchon en liège (20€), boutures et terre fournis."
      ...
      <InscriptionLayout
        ...
        pricing={
          <ul className="space-y-1.5 font-body text-sm text-foreground/80">
            ...
            <li>· <strong>20€</strong> par personne pour un bocal de 5 litres en verre recyclé, bouchon en liège</li>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {([
                ...
                { size: "5L" as const, label: "Bocal 5 litres", desc: "Verre recyclé, bouchon en liège", price: PRICE_5L, stock: STOCK_5L },
              ]).map((opt) => {
