...
const SeminaireEntrepriseValDOise = () => (
  <OccasionTemplate data={{
    ...
    "pitch": "Une animation qui ne ressemble pas aux autres, dans le Val-d'Oise. Un temps végétal en plein milieu de votre séminaire, qui crée du lien autrement et marque durablement.",
    "why": [
        {
    ...
    "faqs": [
        {
            ...
            "a": "Oui, à Cergy, Argenteuil, Sarcelles, Pontoise et plus largement. Notre équipe se déplace avec tout le matériel."
        },
        {
