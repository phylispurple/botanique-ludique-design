        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["MJC de Chatou", "MJC du Vésinet", "MJC de Saint-Germain-en-Laye", "Centres culturels du 92"].map((partner) => (
              <span key={partner} className="inline-flex items-center gap-1 bg-[hsl(var(--yellow))]/15 px-4 py-2 rounded-full text-sm text-charcoal shadow-sm"><CheckCircle className="w-3 h-3 text-sage" />{partner}</span>
            ))}
          </div>
        </div>
      </section>
