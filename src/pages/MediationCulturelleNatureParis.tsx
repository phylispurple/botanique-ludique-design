  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: 'hsl(36 33% 93%)' }}>
      <SEO
        ...
        description="Médiation Culturelle Nature à Paris (75). Conférences, ateliers et interventions botaniques à Paris 1er–20e, Muséum national d'Histoire naturelle, Jardin des Plantes, Cité des Sciences, Médiathèques parisiennes. Ethnobotaniste diplômée EHESS."
      ...
      <SchemaOrg type="Service" data={{
        ...
        description: "Médiation Culturelle Nature pour tous publics à Paris.",
        areaServed: ["Paris"]
      }} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Médiation Culturelle Nature à Paris (75)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Médiation culturelle autour de la nature · Paris · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>médiation culturelle autour de la nature</strong> dans tout le département de Paris (75). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Archivo Black, sans-serif', color: 'hsl(0 0% 10%)', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>
                    Médiation Culturelle Nature à Paris 1er–20e et à Paris
                  </h2>
            ...
            <div className="bg-sage text-[hsl(var(--cream))] p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Archivo Black, sans-serif', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>
                Un projet de médiation culturelle nature à Paris ?
              </h2>
