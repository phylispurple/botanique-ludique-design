...
const MediationCulturelleNatureParis = () => {
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#F7F7EB' }}>
      <SEO
        title="Médiation Culturelle Nature Paris (75)"
        description="Médiation Culturelle Nature dans les Paris (75). Conférences, ateliers et interventions botaniques à Paris 1er–20e, Muséum national d'Histoire naturelle, Jardin des Plantes, Cité des Sciences, Médiathèques parisiennes. Ethnobotaniste diplômée EHESS."
        keywords="médiation culturelle nature, ethnobotanique, conférence plantes cultures, paris, 75, paris 1er–20e, muséum national d'histoire naturelle, jardin des plantes, cité des sciences"
        canonical="/mediation-culturelle-nature-paris"
        region="FR-75"
        city="Paris 1er–20e"
      />
      <SchemaOrg type="Service" data={{
        serviceType: "Médiation Culturelle Nature",
        name: "Médiation Culturelle Nature - Paris (75)",
        description: "Médiation Culturelle Nature pour tous publics dans les Paris.",
        areaServed: ["Paris"]
      }} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <h1 className="page-title text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl mb-6">
                Médiation Culturelle Nature dans les Paris (75)
              </h1>
              <p className="subtitle-italic text-lg mb-6">
                Médiation culturelle autour de la nature · Paris · Tous publics
              </p>
              <p className="text-base text-charcoal/80 leading-relaxed max-w-3xl mx-auto">
                Botanique Ludique propose des interventions de <strong>médiation culturelle autour de la nature</strong> dans tout le département des Paris (75). 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400, color: '#3D3D2E' }}>
                    Médiation Culturelle Nature à Paris 1er–20e et dans les Paris
                  </h2>
                ...
                {[
                  ...
                  <Card key={i} className="hover:shadow-lg transition-shadow animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
                    <CardContent className="p-0">
                      <img src={atelier.src} alt={`Médiation Culturelle Nature Paris - ${atelier.title}`} className="w-full h-48 object-cover rounded-t-lg" loading="lazy" />
                      <div className="p-6">
            ...
            <div className="bg-sage text-off-white rounded-lg p-8 md:p-12 text-center animate-fade-in">
              <h2 className="text-2xl md:text-3xl mb-4" style={{ fontFamily: 'Fraunces, serif', fontWeight: 400 }}>
                Un projet de médiation culturelle nature dans les Paris ?
              </h2>
...
export default MediationCulturelleNatureParis;
