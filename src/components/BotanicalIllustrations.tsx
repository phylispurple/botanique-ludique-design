...
export const LeafBranch: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 60 80" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Butterfly: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 80 60" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Flower: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 60 80" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Bee: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Mushroom: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 60 70" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Snail: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 70 60" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Bird: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Seed: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Strawberry: React.FC<IllustrationProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} viewBox="0 0 50 60" fill="none" xmlns="http://www.w3.org/2000/svg">
