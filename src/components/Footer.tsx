...
const Footer = () => {
  ...
  return (
    <footer className="border-t-2 border-primary" style={{ background: 'hsl(0 0% 10%)' }}>
      <div className="px-6 md:px-16 lg:px-[120px] py-16">
        ...
        {/* Bottom bar */}
        <div className="mt-14 pt-6 border-t border-primary/20 flex flex-col md:flex-row items-center justify-between gap-4">
