...
const ILLUSTRATION_URL = "https://botaniqueludique.com/email-assets/validation-mauvaises-herbes.png"

interface MauvaisesHerbesRegistrationProps {
  firstName?: string
  name?: string
  subject?: string
  userMessage?: string
...
const MauvaisesHerbesRegistrationEmail = ({
  firstName, name, userMessage, participants, price,
}: MauvaisesHerbesRegistrationProps) => (
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Ton inscription à l'atelier Bombes de graines est confirmée</Preview>
    <Body style={main}>
      <Container style={container}>
        {/* Illustration principale, contient toutes les infos pratiques */}
        <Section style={imageSection}>
          <Img
            src={ILLUSTRATION_URL}
            alt="Confirmation d'inscription à l'atelier Bombes de graines, Botanique Ludique, mercredi 6 mai 2026 à 17h, La Rochefoucauld Paris 14e, 7€ matériel compris"
            width="600"
            style={image}
          />
        </Section>

        {/* Bloc personnalisé minimal en dessous */}
...
export const template = {
  component: MauvaisesHerbesRegistrationEmail,
  subject: (data: Record<string, any>) =>
    `Confirmation de ton inscription, ${data.subject || 'Atelier Bombes de graines'}`,
  displayName: 'Confirmation inscription Mauvaises herbes',
  previewData: {
    firstName: 'Marie',
...
// ── Styles sobres : l'image porte le visuel, le texte porte la personnalisation ──
