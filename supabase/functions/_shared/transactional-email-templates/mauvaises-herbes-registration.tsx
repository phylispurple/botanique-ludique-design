...
const MauvaisesHerbesRegistrationEmail = ({ firstName, name, userMessage }: MauvaisesHerbesRegistrationProps) => (
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Confirmation de ton inscription, Atelier Mauvaises herbes</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={topBand} />

        <Section style={header}>
          <Text style={headerLabel}>ATELIER MAUVAISES HERBES</Text>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Merci pour ton inscription à l'atelier Mauvaises herbes, j'ai hâte de t'y retrouver !
          </Text>

          <Text style={text}>
            Au programme : histoire des jardins punk et politique des plantes sauvages en ville, suivie de la fabrication de bombes à graines à lancer dans les friches urbaines.
          </Text>

          <Text style={textBold}>Rendez-vous :</Text>
          <Text style={text}>
            Mercredi 6 mai 2026, 17h00{'\n'}
            La Rochefoucauld, Paris 14e (Denfert-Rochereau)
          </Text>

          <Text style={textBold}>Règlement :</Text>
          <Text style={text}>
            7€ matériel compris. Le règlement se fait en espèces sur place, 10 à 15 minutes avant le début de l'atelier.
          </Text>
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    `Confirmation de ton inscription, ${data.subject || 'Atelier Mauvaises herbes'}`,
