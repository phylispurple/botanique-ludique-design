...
const TeinturesRegistrationEmail = ({ firstName, name, userMessage }: TeinturesRegistrationProps) => (
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Confirmation de ton inscription, Atelier Teintures végétales</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={topBand} />

        <Section style={header}>
          <Text style={headerLabel}>ATELIER TEINTURES VÉGÉTALES</Text>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Merci pour ton inscription à l'atelier Histoire culturelle et politique des teintures végétales, j'ai hâte de t'y retrouver !
          </Text>

          <Text style={text}>
            Au programme : de l'indigo des esclaves aux Antilles au curcuma de votre cuisine, nous retracerons l'histoire politique des couleurs végétales, suivie d'une initiation pratique à la teinture.
          </Text>

          <Text style={textBold}>Rendez-vous :</Text>
          <Text style={text}>
            Mercredi 27 mai 2026, 17h00{'\n'}
            La Rochefoucauld, Paris 14e (Denfert-Rochereau)
          </Text>

          <Text style={textBold}>Règlement :</Text>
          <Text style={text}>
            8€ matériel fourni. Le règlement se fait en espèces sur place, 10 à 15 minutes avant le début de l'atelier.
          </Text>
