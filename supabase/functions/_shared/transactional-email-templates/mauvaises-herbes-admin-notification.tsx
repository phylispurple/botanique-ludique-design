...
const AdminNotificationEmail = ({
  ...
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Nouvelle inscription Mauvaises herbes – {fullName || 'Participant'}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Atelier Mauvaises herbes</Heading>
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    `[Botanique Ludique] Inscription Mauvaises herbes – ${data.fullName || 'Nouveau participant'}`,
  displayName: 'Notification admin inscription Mauvaises herbes',
