...
const AdminNotificationEmail = ({
  fullName, email, phone, participants, price, message,
}: AdminNotificationProps) => (
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Nouvelle inscription Teintures végétales – {fullName || 'Participant'}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Atelier Teintures végétales</Heading>
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    `[Botanique Ludique] Inscription Teintures végétales – ${data.fullName || 'Nouveau participant'}`,
  displayName: 'Notification admin inscription Teintures végétales',
  ...
  previewData: {
    ...
    participants: '2',
    price: '16€ pour 2 personnes',
    message: 'Faut-il prévoir des vêtements particuliers ?',
  },
